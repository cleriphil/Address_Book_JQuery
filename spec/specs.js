describe('Contact', function() {
  ...
  it("adds fullName functionality to a contact", function(){
    var testContact = new Contact("Will", "Wheaton");
    expect(testContact.fullName()).to.equal("Will Wheaton");
  });
});

describe('Address', function() {
  it("creates a new address witht he given specifications", function() {
  ...
  it("adds the fullAddress method to all addresses", function() {
    var testAddress = new Address("123 Main St", "Test City", "Test State");
    expect(testAddress.fullAddress()).to.equal("123 Main St\nTest City, Test State");
  });
});
